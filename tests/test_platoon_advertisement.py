...
def test_creation():
    ...
    assert(message.destination is destination)
    assert(message.data is None)
    assert(message.platoon_id is platoon_id)
    assert(message.leader_id is leader_id)
    assert(message.platoon_speed is platoon_speed)
    assert(message.platoon_lane is platoon_lane)
    assert(message.platoon_formation is platoon_formation)
    assert(message.platoon_position_front is platoon_position_front)
    assert(message.platoon_position_back is platoon_position_back)
