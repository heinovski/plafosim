...
#   depart_lane = 0  # start on lane 0 for now
    ...
    vehicles.append(Vehicle(vid, depart_position, arrival_position, desired_speed, depart_speed,
                            depart_lane, depart_time, length, max_acceleration, max_deceleration))
